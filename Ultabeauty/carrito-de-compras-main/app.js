...
//EVENTO 1 PERSONALIZADO: USUARIO INACTIV
// Evento personalizado "usuarioInactivo"
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function mostrarReseñas() {
        ...
        reseñasFiltradas.forEach(function(reseña) {
            ...
            div.innerHTML = '<p>' + reseña.texto + ' - Calificación: ' + reseña.calificacion + ' &#9733;</p>';
